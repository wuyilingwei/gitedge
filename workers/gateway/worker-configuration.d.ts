/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/gateway/wrangler.jsonc workers/gateway/worker-configuration.d.ts` (hash: 339c1fc739893d5fae30e4e094a9e046)
