/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/gateway/wrangler.jsonc workers/gateway/worker-configuration.d.ts` (hash: 5553da84ddc9a333389c5c544a3a21ac)
// Runtime types generated with workerd@1.20260825.1 2026-08-26
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	IP_RPM_LIMIT: "300";
	USER_GROUP_LIMITS_JSON: "{\"free\":{\"rpm\":120,\"maxRepositories\":10,\"maxPushBytes\":268435456,\"maxRepositoryBytes\":1073741824,\"maxStorageBytes\":5368709120},\"team\":{\"rpm\":600,\"maxRepositories\":100,\"maxPushBytes\":1073741824,\"maxRepositoryBytes\":10737418240,\"maxStorageBytes\":107374182400},\"admin\":{\"rpm\":1200,\"maxRepositories\":1000,\"maxPushBytes\":5368709120,\"maxRepositoryBytes\":107374182400,\"maxStorageBytes\":1099511627776}}";
	RATE_LIMITER: DurableObjectNamespace /* SharedRateLimitDurableObject from gitedge-limits */;
	AUTH: Fetcher /* gitedge-auth */;
	FORGE: Fetcher /* gitedge-forge */;
	GIT: Fetcher /* gitedge-git */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IP_RPM_LIMIT" | "USER_GROUP_LIMITS_JSON">> {}
}
